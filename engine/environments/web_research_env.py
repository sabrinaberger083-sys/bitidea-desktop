...
Inspired by: GroceryMind — production Bitidea agent doing live web research
             across German grocery stores (firecrawl + bitidea-agent)
"""
...
# Ensure bitidea-agent root is on path
...
class WebResearchEnvConfig(BitideaAgentEnvConfig):
...
class WebResearchEnv(BitideaAgentBaseEnv):
    """
