...
ALL bitidea-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all bitidea-agent tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_bitidea_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any bitidea-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("BITIDEA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("BITIDEA_QUIET", None)
            else:
                os.environ["BITIDEA_QUIET"] = _prev_quiet
