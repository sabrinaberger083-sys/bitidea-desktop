"""
BitideaSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser bitidea
    run-api
    python environments/bitidea_swe_env.py serve \\
...
class BitideaSweEnv(BitideaAgentBaseEnv):
    ...
    name = "bitidea-swe"
    env_config_cls = BitideaSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[BitideaSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = BitideaSweEnvConfig(
            ...
            tool_call_parser="bitidea",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="bitidea-swe",
        )
