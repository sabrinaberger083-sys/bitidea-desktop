"""
Monkey patches for making bitidea-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by bitidea_base_env.py).
