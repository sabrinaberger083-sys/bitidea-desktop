...
# Minimum context length required to run Bitidea Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Bitidea from probing-down to
...
def _get_context_cache_path() -> Path:
    ...
    return get_bitidea_home() / "context_length_cache.yaml"
        ...
        with httpx.Client(timeout=3.0) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Bitidea grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Bitidea sends to providers:
