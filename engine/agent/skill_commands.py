...
def build_plan_path(
    ...
    *,
    ...
    workspace instead of the Bitidea host's global home directory.
    """
    ...
    return Path(".bitidea") / "plans" / f"{timestamp}-{slug}.md"
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.bitidea.config``
    ...
    try:
        ...
        lines = ["", f"[Skill config (from {display_bitidea_home()}/config.yaml):"]
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    """Scan ~/.bitidea/skills/ and return a mapping of /command -> skill info.
