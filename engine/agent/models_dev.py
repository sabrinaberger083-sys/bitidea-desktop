...
Data resolution order (like TypeScript OpenCode):
  ...
  2. Disk cache (~/.bitidea/models_dev_cache.json)
...
# ---------------------------------------------------------------------------
# Provider ID mapping: Bitidea ↔ models.dev
# ---------------------------------------------------------------------------

# Bitidea provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Bitidea (built lazily)
...
def _get_cache_path() -> Path:
    ...
    return get_bitidea_home() / "models_dev_cache.json"
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Bitidea provider ID to its models dict from models.dev.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Bitidea provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Bitidea ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Bitidea or models.dev provider ID.  Tries exact match then
