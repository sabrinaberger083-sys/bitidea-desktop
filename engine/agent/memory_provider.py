...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - bitidea_home (str): The active BITIDEA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.bitidea``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "bitidea").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'bitidea memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], bitidea_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'bitidea memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``bitidea_home`` is the active BITIDEA_HOME directory path.
