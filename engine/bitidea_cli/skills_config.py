"""
Skills configuration for Bitidea Agent.
`bitidea skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.bitidea/config.yaml under:
...
from bitidea_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `bitidea skills`."""
    from bitidea_cli.curses_ui import curses_checklist
