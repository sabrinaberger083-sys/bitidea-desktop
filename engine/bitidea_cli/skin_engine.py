"""Bitidea CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.bitidea/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Bitidea Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ◆"              # Shown on exit
      response_label: " ◆ Bitidea "       # Response box header label
...
.. code-block:: python
    ...
    from bitidea_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Bitidea Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.bitidea/skins/
...
Drop a YAML file in ``~/.bitidea/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces BITIDEA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces BITIDEA_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Bitidea blue — clean, focused, default",
        "colors": {
            "banner_border": "#0C4A99",
            "banner_title": "#1A73E8",
            "banner_accent": "#4A9EFF",
            "banner_dim": "#5B6B82",
            "banner_text": "#E8F0FE",
            "ui_accent": "#1A73E8",
            "ui_label": "#4dd0e1",
            ...
            "prompt": "#E8F0FE",
            "input_rule": "#0C4A99",
            "response_border": "#1A73E8",
            "session_label": "#4A9EFF",
            "session_border": "#5B6B82",
        },
        "spinner": {
            # Empty = use hardcoded defaults in display.py
        },
        "branding": {
            "agent_name": "Bitidea Agent",
            "welcome": "Welcome to Bitidea Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ◆",
            "response_label": " ◆ Bitidea ",
            "prompt_symbol": "❯ ",
