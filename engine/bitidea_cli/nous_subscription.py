...
from bitidea_cli.config import get_env_value, load_config
...
def get_nous_subscription_features(
    ...
    # Tool Gateway via `bitidea model`, so direct credentials should NOT
...
def prompt_enable_tool_gateway(config: Dict[str, object]) -> set[str]:
    ...
    try:
        from bitidea_cli.setup import prompt_choice
    except Exception:
        return set()
