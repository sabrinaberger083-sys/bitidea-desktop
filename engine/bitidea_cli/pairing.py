...
Usage:
    bitidea pairing list              # Show all pending + approved users
    bitidea pairing approve <platform> <code>  # Approve a pairing code
    bitidea pairing revoke <platform> <user_id> # Revoke user access
    bitidea pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle bitidea pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: bitidea pairing {list|approve|revoke|clear-pending}")
        print("Run 'bitidea pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'bitidea pairing list' to see pending codes.\n")
