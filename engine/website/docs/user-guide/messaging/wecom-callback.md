...
Connect Bitidea to WeCom (Enterprise WeChat) as a self-built enterprise application using the callback/webhook model.

:::info WeCom Bot vs WeCom Callback
Bitidea supports two WeCom integration modes:
...
3. Bitidea decrypts the message, queues it for the agent
