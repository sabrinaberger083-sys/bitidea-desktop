...
Config via environment variables (profile-scoped via each profile's .env):
  ...
  OPENVIKING_AGENT   — Tenant agent (default: bitidea)
...
class _VikingClient:
    ...
    def __init__(self, endpoint: str, api_key: str = "",
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "bitidea")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {
                "key": "agent",
                "description": "OpenViking agent ID within the account ([bitidea], useful in multi-agent mode)",
                "default": "bitidea",
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "bitidea")
