...
Copies bundled skills from the repo's skills/ directory into ~/.bitidea/skills/
...
The manifest lives at ~/.bitidea/skills/.bundled_manifest.
"""
...
def _get_bundled_dir() -> Path:
    ...
    Checks BITIDEA_BUNDLED_SKILLS env var first (set by Nix wrapper),
    then falls back to the relative path from this source file.
    """
    env_override = os.getenv("BITIDEA_BUNDLED_SKILLS")
    if env_override:
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.bitidea/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.bitidea/skills/ using the manifest.
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.bitidea/skills/ ...")
