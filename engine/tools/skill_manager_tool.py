...
~/.bitidea/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.bitidea/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.bitidea/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_bitidea_home()}/skills/; existing skills can be modified wherever they live.\n\n"
