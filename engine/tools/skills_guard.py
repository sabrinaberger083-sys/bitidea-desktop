...
Trust levels:
  - builtin:   Ships with Bitidea. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.bitidea/\.env|\~/\.bitidea/\.env',
     "bitidea_env_access", "critical", "exfiltration",
     "directly references Bitidea secrets file"),
    ...
    (r'\.bitidea/config\.yaml|\.bitidea/SOUL\.md',
     "bitidea_config_mod", "critical", "persistence",
     "references Bitidea configuration files directly"),
