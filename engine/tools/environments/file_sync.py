...
_FORCE_SYNC_ENV = "BITIDEA_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.bitidea") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.bitidea to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``BITIDEA_FORCE_FILE_SYNC=1`` is set.
