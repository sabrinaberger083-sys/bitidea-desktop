...
_SNAPSHOT_STORE = get_bitidea_home() / "singularity_snapshots.json"
...
def _get_scratch_dir() -> Path:
    ...
    if scratch.exists() and os.access(scratch, os.W_OK):
        user_scratch = scratch / os.getenv("USER", "bitidea") / "bitidea-agent"
...
class SingularityEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        if self._persistent:
            overlay_base = _get_scratch_dir() / "bitidea-overlays"
