...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "bitidea-ssh"
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.bitidea"),
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.bitidea directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.bitidea"
    ...
    def _ssh_bulk_upload(self, files: list[tuple[str, str]]) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="bitidea-ssh-bulk-") as staging:
