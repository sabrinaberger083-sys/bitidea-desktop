...
def _browser_candidate_path_dirs() -> list[str]:
    ...
    bitidea_node_bin = str(bitidea_home / "node" / "bin")
    return [bitidea_node_bin, *list(_discover_homebrew_node_dirs()), *_SANE_PATH_DIRS]
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, Bitidea-managed
    ...
    # Build an extended search PATH including Bitidea-managed Node, macOS
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = bitidea_home / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> str:
    ...
    screenshots_dir = get_bitidea_dir("cache/screenshots", "browser_screenshots")
