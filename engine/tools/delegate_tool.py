...
# (bitidea-* prefixed), and scenario toolsets.
...
_SUBAGENT_TOOLSETS = sorted(
    ...
    and not name.startswith("bitidea-")
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    if not api_key:
        raise ValueError(
            ...
            f"Set the appropriate environment variable or run 'bitidea auth'."
        )
...
def _load_config() -> dict:
    ...
    to the persistent config (bitidea_cli/config.py load_config()) so that
