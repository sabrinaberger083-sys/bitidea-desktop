...
A runner that uses Bitidea-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Hermes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Bitidea-Agent's Docker, Modal, or Local environments for command execution
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Bitidea-Agent's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses Bitidea-Agent's built-in execution environments
    ...
    def _convert_to_bitidea_format(
        self,
...
Complete the user's task step by step."""
        ...
        trajectory = self._convert_to_bitidea_format(messages, task, completed)
