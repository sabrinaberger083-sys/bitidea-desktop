...
DEFAULT_DATASETS = [
    ...
    "sabrinaberger083-sys/bitidea-agent-megascience-sft1",
    "NousResearch/Bitidea-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Bitidea-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-bitidea-agent"
]
