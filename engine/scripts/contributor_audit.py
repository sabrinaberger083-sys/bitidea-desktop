...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Bitidea\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "bitidea@nousresearch.com",
    "bitidea-audit@example.com",
    "bitidea@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "sabrinaberger083-sys/bitidea-agent",
                "--state", "merged",
