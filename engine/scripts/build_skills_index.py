#!/usr/bin/env python3
"""Build the Bitidea Skills Index — a centralized JSON catalog of all skills.
...
`bitidea skills search/install` can use it without hitting the GitHub API.
...
# Ensure BITIDEA_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("BITIDEA_HOME", os.path.join(os.path.expanduser("~"), ".bitidea"))
...
def main():
    print("Building Bitidea Skills Index...", flush=True)
