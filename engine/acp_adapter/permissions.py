"""ACP permission bridging — maps ACP approval requests to bitidea approval callbacks."""
...
# Maps ACP PermissionOptionKind -> bitidea approval result strings
_KIND_TO_HERMES = {
    "allow_once": "once",
    "allow_always": "always",
    "reject_once": "deny",
...
def make_approval_callback(
    ...
    """
    Return a bitidea-compatible ``approval_callback(command, description) -> str``
