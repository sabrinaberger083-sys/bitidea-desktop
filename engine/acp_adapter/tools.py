"""ACP tool-call helpers for mapping bitidea tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map bitidea tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a bitidea tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given bitidea tool invocation."""
