...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Bitidea toolsets (CLI + messaging platforms)
    #
    ...
    "bitidea-email": {
        "description": "Email bot toolset - interact with Bitidea via email (IMAP/SMTP)",
        "tools": _BITIDEA_CORE_TOOLS,
        "includes": []
    },
    ...
    "bitidea-sms": {
        "description": "SMS bot toolset - interact with Bitidea via SMS (Twilio)",
        "tools": _BITIDEA_CORE_TOOLS,
        "includes": []
    },
    ...
    "bitidea-gateway": {
        ...
        "tools": [],
        "includes": ["bitidea-telegram", "bitidea-discord", "bitidea-whatsapp", "bitidea-slack", "bitidea-signal", "bitidea-bluebubbles", "bitidea-homeassistant", "bitidea-email", "bitidea-sms", "bitidea-mattermost", "bitidea-matrix", "bitidea-dingtalk", "bitidea-feishu", "bitidea-wecom", "bitidea-wecom-callback", "bitidea-weixin", "bitidea-qqbot", "bitidea-webhook"]
    }
}
