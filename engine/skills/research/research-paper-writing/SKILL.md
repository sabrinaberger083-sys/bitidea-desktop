...
## Bitidea Agent Integration

This skill is designed for the Bitidea agent. It uses Bitidea tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Bitidea skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.bitidea/plans/` | `skill_view("plan")` |
