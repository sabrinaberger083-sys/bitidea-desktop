...
Built for [Bitidea Agent](https://github.com/sabrinaberger083-sys/bitidea-agent). Usable in any coding agent. Canonical source lives here; synced to [`sabrinaberger083-sys/bitidea-agent/skills/creative/ascii-video`](https://github.com/sabrinaberger083-sys/bitidea-agent/tree/main/skills/creative/ascii-video) via PR.
