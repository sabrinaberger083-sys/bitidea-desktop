...
version: 1.1.0
author: Bitidea Agent (adapted from obra/superpowers)
license: MIT
metadata:
  bitidea:
...
> **For Bitidea:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Bitidea tools to understand the project:
