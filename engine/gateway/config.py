...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_bitidea_home() / "sessions")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        sessions_dir = get_bitidea_home() / "sessions"
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.bitidea/config.yaml (primary user-facing config)
    3. ~/.bitidea/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_bitidea_home()
    gw_data: dict = {}
