"""
Email platform adapter for the Bitidea gateway.

Allows users to interact with Bitidea by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Bitidea Agent")
        ...
        msg_id = f"<bitidea-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
