...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_bitidea_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/bitidea")
            async def handle_bitidea_command(ack, command):
                await ack()
                await self._handle_slash_command(command)

            # Register Block Kit action handlers for approval buttons
            for _action_id in (
                "bitidea_approve_once",
                "bitidea_approve_session",
                "bitidea_approve_always",
                "bitidea_deny",
            ):
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own Bitidea session — matching the per-thread behavior channels already
                ...
                },
                {
                    ...
                    "elements": [
                        ...
                        },
                        {
                            ...
                            "action_id": "bitidea_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "bitidea_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "bitidea_approve_once": "once",
            "bitidea_approve_session": "session",
            "bitidea_approve_always": "always",
            "bitidea_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from bitidea_cli.commands import slack_subcommand_map
