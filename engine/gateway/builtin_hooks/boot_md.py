"""Built-in boot-md hook — run ~/.bitidea/BOOT.md on gateway startup.

This hook is always registered. It silently skips if no BOOT.md exists.
To activate, create ``~/.bitidea/BOOT.md`` with instructions for the
...
BOOT_FILE = BITIDEA_HOME / "BOOT.md"
