"""
Session-scoped context variables for the Bitidea gateway.

Replaces the previous ``os.environ``-based session state
(``BITIDEA_SESSION_PLATFORM``, ``BITIDEA_SESSION_CHAT_ID``, etc.) with
...
messages arrive at the same time the old code did:
    ...
    os.environ["BITIDEA_SESSION_THREAD_ID"] = str(context.source.thread_id)
...
``os.getenv("BITIDEA_SESSION_*", ...)`` calls.  Existing tool code only
needs to replace the import + call site:

    # before
    import os
    platform = os.getenv("BITIDEA_SESSION_PLATFORM", "")
...
_SESSION_PLATFORM: ContextVar = ContextVar("BITIDEA_SESSION_PLATFORM", default=_UNSET)
_SESSION_CHAT_ID: ContextVar = ContextVar("BITIDEA_SESSION_CHAT_ID", default=_UNSET)
_SESSION_CHAT_NAME: ContextVar = ContextVar("BITIDEA_SESSION_CHAT_NAME", default=_UNSET)
_SESSION_THREAD_ID: ContextVar = ContextVar("BITIDEA_SESSION_THREAD_ID", default=_UNSET)
_SESSION_USER_ID: ContextVar = ContextVar("BITIDEA_SESSION_USER_ID", default=_UNSET)
_SESSION_USER_NAME: ContextVar = ContextVar("BITIDEA_SESSION_USER_NAME", default=_UNSET)
_SESSION_KEY: ContextVar = ContextVar("BITIDEA_SESSION_KEY", default=_UNSET)

_VAR_MAP = {
    "BITIDEA_SESSION_PLATFORM": _SESSION_PLATFORM,
    "BITIDEA_SESSION_CHAT_ID": _SESSION_CHAT_ID,
    "BITIDEA_SESSION_CHAT_NAME": _SESSION_CHAT_NAME,
    "BITIDEA_SESSION_THREAD_ID": _SESSION_THREAD_ID,
    "BITIDEA_SESSION_USER_ID": _SESSION_USER_ID,
    "BITIDEA_SESSION_USER_NAME": _SESSION_USER_NAME,
    "BITIDEA_SESSION_KEY": _SESSION_KEY,
}
...
def get_session_env(name: str, default: str = "") -> str:
    """Read a session context variable by its legacy ``BITIDEA_SESSION_*`` name.

    Drop-in replacement for ``os.getenv("BITIDEA_SESSION_*", default)``.
