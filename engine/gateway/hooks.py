...
Hooks are discovered from ~/.bitidea/hooks/ directories, each containing:
...
HOOKS_DIR = get_bitidea_home() / "hooks"
    ...
    def _register_builtin_hooks(self) -> None:
        ...
        try:
            ...
            self._loaded_hooks.append({
                "name": "boot-md",
                "description": "Run ~/.bitidea/BOOT.md on gateway startup",
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    f"bitidea_hook_{hook_name}", handler_path
                )
