...
4. Name the token (e.g., "Bitidea Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.bitidea/.env`:
...
```bash
CANVAS="python $BITIDEA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
