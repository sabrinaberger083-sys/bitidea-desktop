...
Data file: $BITIDEA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_BITIDEA_HOME = Path(os.environ.get("BITIDEA_HOME", Path.home() / ".bitidea"))
DATA_DIR = _BITIDEA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
